          ...
          body={
            <Switch>
              <Match when={props.request.always.length === 1 && props.request.always[0] === "*"}>
                <TextBody title={"This will allow " + props.request.permission + " until Ocarina is restarted."} />
              </Match>
              <Match when={true}>
                <box paddingLeft={1} gap={1}>
                  <text fg={theme.textMuted}>This will allow the following patterns until Ocarina is restarted</text>
                  <box>
      ...
      <Match when={store.stage === "permission"}>
        {(() => {
          const info = () => {
            ...
            return {
              icon: "△",
              title: "Research permission required",
              body: (
                <box paddingLeft={1}>
                  <text fg={theme.textMuted}>Ocarina needs your approval before continuing.</text>
                </box>
              ),
            }
          }
  ...
  return (
    ...
    >
      <box gap={1} paddingLeft={1} paddingRight={3} paddingTop={1} paddingBottom={1}>
        ...
        <box paddingLeft={1}>
          <text fg={theme.textMuted}>Tell Ocarina what to do differently</text>
        </box>
      </box>
      <box
