...
export function createSlots() {
  // A plugin slot is optional. Keep the built-in content visible when no
  // plugin host is connected; otherwise replace-mode slots blank the home
  // screen during the normal Ocarina startup path.
