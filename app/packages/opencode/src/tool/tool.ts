...
/** Raised when an internal legacy path attempts a tool disabled by policy. */
export class DisabledError extends Schema.TaggedErrorClass<DisabledError>()("ToolDisabledError", {
  tool: Schema.String,
}) {}
